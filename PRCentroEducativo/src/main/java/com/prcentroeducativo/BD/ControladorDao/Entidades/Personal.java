...
public class Personal {
    ...
    public Personal(String dni, String nombre, String apellido1, String apellido2, String direccion, int cp, String poblacion, String provincia, int telefono, String email, int tipo) {
        this.dni = dni;
        this.nombre = nombre;
